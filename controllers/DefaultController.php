...
class DefaultController extends Controller {
	...
	public function behaviors() {
		return [
			...
			'access' => [
				...
				'only' => ['index', 'update', 'create', 'delete', 'missing', 'scan', 'cache'],
				'rules' => [
					[
						'actions' => ['index', 'update', 'create', 'delete', 'missing', 'scan', 'cache'],
						'allow' => true,
						'roles' => ['@'],
						'matchCallback' => function ($rule, $action) {
							return \Yii::$app->user->can('translator');
						}
					],
				],
			],
	...
	protected function findModel($attributes) {
